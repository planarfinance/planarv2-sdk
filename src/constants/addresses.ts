...
export const USDC_ADDRESS: AddressMap = {
  ...
  [ChainId.SEPOLIA]: '0x0D81e9C83fC5401f7aC275FE7Ac8Bc7744FB7509',
  ...
  [ChainId.BLAST_SEPOLIA]: '0x90f47758526d83ebAE13e5048E45b77420F06D95',
}
...
export const USD_ADDRESS: AddressMap = {
  ...
  [ChainId.BLAST_SEPOLIA]: USDC_ADDRESS[ChainId.BLAST_SEPOLIA],
}
...
export const DAI_ADDRESS: AddressMap = {
  ...
  [ChainId.SEPOLIA]: '0x7D1610d1f4Ec60CA978480361a4AefbDd1AFF9C0',
  ...
  [ChainId.BLAST_SEPOLIA]: '0xCFCbc0D05C2D7F029C2aAF58C1832B798E8526Df',
}
...
export const USDT_ADDRESS: AddressMap = {
  ...
  [ChainId.SEPOLIA]: '0x3D62ebc48eC32935d59e257884AF229Ee18F3f3c',
  ...
  [ChainId.BLAST_SEPOLIA]: '0xF388a60d368CBf5C353AF4e66E313e2AC3948702',
}
...
export const FACTORY_ADDRESS: AddressMap = {
  ...
  [ChainId.ARBITRUM]: '0x6EcCab422D763aC031210895C81787E87B43A652', // CamelotFactory
  [ChainId.SEPOLIA]: '0xBF5bba4B4608A8eCA7331d9D18AF64fAb738092F', // PlanarLiquidityPoolFactory
  ...
  [ChainId.BLAST_SEPOLIA]: '0xd666b7a4CdEfb3d5e95eBe31F9725Cc52328c2b0',
}
...
export const ROUTER_ADDRESS: AddressMap = {
  ...
  [ChainId.ARBITRUM]: '0xc873fEcbd354f5A56E00E710B90EF4201db2448d', // CamelotRouter
  [ChainId.SEPOLIA]: '0x7cE6133ec46651Ca6044215d894f4a0066800C10', // PlanarLiquidityPoolRouter
  [ChainId.ARBITRUM_TESTNET]: '',
  ...
  [ChainId.BLAST_SEPOLIA]: '0xBF5bba4B4608A8eCA7331d9D18AF64fAb738092F',
}
...
export const MULTICALL2_ADDRESS: AddressMap = {
  ...
  [ChainId.SEPOLIA]: '0xE10FB602595AEA04ad8b94106b9ae833eA231Bdc',
  ...
  [ChainId.BLAST_SEPOLIA]: '0x21e86e168377e34cFE6e957471C50245e139716d',
}
...
export const BALANCE_FETCHER_ADDRESS: AddressMap = {
  ...
  [ChainId.SEPOLIA]: '0x79C68e83B600B12F056B2877B562b73f1C31704c',
  [ChainId.HECO]: '0x4d4A0D45a98AE8EC25b359D93A088A87BC9eF70b',
  [ChainId.KOVAN]: '0x980bE39AC44E5500f0f16bA692084A6E44e6549A',
  [ChainId.BLAST_SEPOLIA]: '0x1aed7A0c0194f4F7bB5f808B70B25380De3a11bd',
}
...
export const GRAIL_ADDRESS: AddressMap = {
  ...
  [ChainId.SEPOLIA]: '0xc4bA0D583dDD54bDb08F442A9487672F48C16b47',
  [ChainId.BLAST_SEPOLIA]: '0xC36f679a50f450c0ce356eA88a050d6ed72F5b0b',
}

export const PLANARTESTTOKENFAUCET_ADDRESS: AddressMap = {
  [ChainId.SEPOLIA]: '0xcCe8F3dD2fA88fdBF2c2deDcCc9D37008fBf670d',
  [ChainId.BLAST_SEPOLIA]: '0x2671b7b5C0C63e3260538e95A3CcB3aDd1D0b589',
}

export const PLANARLIQUIDITYPOOLFACTORY_ADDRESS: AddressMap = {
  // FACTORY_ADDRESS also serve the same value
  [ChainId.SEPOLIA]: '0xBF5bba4B4608A8eCA7331d9D18AF64fAb738092F',
  [ChainId.BLAST_SEPOLIA]: '0xd666b7a4CdEfb3d5e95eBe31F9725Cc52328c2b0',
}

export const PLANARLIQUIDITYPOOLROUTER_ADDRESS: AddressMap = {
  // ROUTER_ADDRESS also serve the same value
  [ChainId.SEPOLIA]: '0x7cE6133ec46651Ca6044215d894f4a0066800C10',
  [ChainId.BLAST_SEPOLIA]: '0xBF5bba4B4608A8eCA7331d9D18AF64fAb738092F',
}

export const POSITIONHELPER_ADDRESS: AddressMap = {
  [ChainId.SEPOLIA]: '0x6E84593B20B137C48Ef62D0142D78bF32266DF40',
  [ChainId.BLAST_SEPOLIA]: '0xF53aEe7D641c202A04D230b1372c29482407B465',
}
...
export const XPLANETOKEN_ADDRESS: AddressMap = {
  [ChainId.SEPOLIA]: '0x55E8c69514Cea2F779457edAFf3ab1d2c9CB15e4',
  [ChainId.BLAST_SEPOLIA]: '0x2A21bA37D4Ba4A5F7cd3A937e559a029F1bc5a44',
}

export const PLANARMASTER_ADDRESS: AddressMap = {
  [ChainId.SEPOLIA]: '0x7126fB0B94fa4792b93CFc3C3de5Ea13F23d530A',
  [ChainId.BLAST_SEPOLIA]: '0xFc5b2cd8Ce12Ee0cA4F1F9653c6c058636E3Fc8f',
}

export const LPNFTPOOLFACTORY_ADDRESS: AddressMap = {
  [ChainId.SEPOLIA]: '0xEAf3d30381Ef66c3163B7D5D5c5d6F002691bE12',
  [ChainId.BLAST_SEPOLIA]: '0xbeeF35133df823096A5E3542310Be7cAD848E4DE',
}

export const YIELDBOOSTER_ADDRESS: AddressMap = {
  [ChainId.SEPOLIA]: '0x631899e91b925823a7E8995dC267169679719B7a',
  [ChainId.BLAST_SEPOLIA]: '0xe52561a0a152255b63fa95bf63bCd7a777D4B9A8',
}

export const DIVIDENDSV2_ADDRESS: AddressMap = {
  [ChainId.SEPOLIA]: '0x3e5eEE161634Ccb78D16A83C343140B68bbAE078',
  [ChainId.BLAST_SEPOLIA]: '0xBE6b004Ce80DAb15793D4CD323316C567EAC9553',
}

export const LAUNCHPAD_ADDRESS: AddressMap = {
  [ChainId.SEPOLIA]: '0xF4Fa7cF069aeD581a2575464696F9DC14605DC25',
  [ChainId.BLAST_SEPOLIA]: '0xe7F15E044569fe90bE6C96A7e23c18F4a8750E4A',
}

export const PROTOCOLEARNINGS_ADDRESS: AddressMap = {
  [ChainId.SEPOLIA]: '0xb01a8d10FDC45B5A02cC3A371c6618EEC18d2E58',
  [ChainId.BLAST_SEPOLIA]: '0x7Ea469C6bAdD53Ee52C4819C69aF96aB6F8aC4Eb',
}

export const HYPERPOOLFACTORY_ADDRESS: AddressMap = {
  [ChainId.SEPOLIA]: '0x1BC088a9cdBdd65ceE2e57EB39F438c7C3b5bD76',
  [ChainId.BLAST_SEPOLIA]: '0xE26ebe1E3760F49cE6c9184E5A92f72985e26052',
}
