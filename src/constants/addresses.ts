...
export const PLANARLIQUIDITYPOOLFACTORY_ADDRESS: AddressMap = { // FACTORY_ADDRESS also serve the same value
  [ChainId.SEPOLIA]: '0xBF5bba4B4608A8eCA7331d9D18AF64fAb738092F'
}

export const PLANARLIQUIDITYPOOLROUTER_ADDRESS: AddressMap = { // ROUTER_ADDRESS also serve the same value
